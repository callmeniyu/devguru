...
import muhsin_img from "../../assets/images/muhsin_img.jpg"
const Team = () => {
    return (
        <div className="team">
            ...
            >
                ...
                <SplideSlide key={5} className="splide-container">
                    <IdCard
                        data={{
                            name: "Muhsin Kalodi",
                            ...
                            experience: "2",
                            projects: "10",
                            github: "https://github.com/muhsinkalodi",
                            linkedin: "https://www.linkedin.com/in/muhsin-kalodi-8872531b5?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
                            img: muhsin_img,
                        }}
                    />
                </SplideSlide>
